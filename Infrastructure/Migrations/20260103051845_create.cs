        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    nextChange = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    oiltybe = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    KM = table.Column<double>(type: "float", nullable: false),
                    workshopId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_oliTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_oliTypes_AspNetUsers_workshopId",
                        column: x => x.workshopId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    KmReading = table.Column<int>(type: "int", nullable: false),
                    NumberOfKilometers = table.Column<int>(type: "int", nullable: false),
                    FilterChanged = table.Column<bool>(type: "bit", nullable: false),
                    OilChanged = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_ServiceSessions_AspNetUsers_workShopId",
                        column: x => x.workShopId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceSessions_workShopId",
                table: "ServiceSessions",
                column: "workShopId");
